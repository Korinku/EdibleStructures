...
import me.korinku.ediblestructures.items.ThrowableAmethystEntity;
...
public class ThrowableAmethystShard extends EnchantedItem {

	public ThrowableAmethystShard(Settings settings) {
		super(settings);
	}
	...
	public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
		...
		if (!world.isClient) {
			ThrowableAmethystEntity snowballEntity = new ThrowableAmethystEntity(world, user);
